...
at
% \\ \href{https://github.com/saad0105050/multihonest-code}{https://github.com/saad0105050/multihonest-code}
...
% 	\end{axis}%
% \end{tikzpicture}%
% \caption{The probabilities from Table~\ref{table:exact-probs-mh}  
