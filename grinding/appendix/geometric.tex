...
Recall the XOR target game from Definition~\ref{def:adaptive-game} 
...
\end{definition}
% Before we can specialize Lemma~\ref{lemma:adaptive-moment} for an $(\ell, n, \alpha)$-geometric game, 
