...
a single-player multi-round game where the player $\Adversary$ (i.e., the adversary) 
...
\section{An informal view of XOR target games.}
Below, we provide a bird's eye view of the XOR target game 
highlight its correspondence with the eventual consensus beacon protocol $\Pi_\Beacon$. 
\begin{enumerate}    
...
\section{Option sets of any size\texorpdfstring{; the $(\ell, n, \Distribution)$-game}{}}
    ...
    \begin{lemma}\label{lemma:xorgame-moment}
        % Let $m \in [n]$.
