...
in an epoch that contribute in computing the beacon output --  contains 
no empty slots, i.e., all $s$ slots are non-empty with probability 1, 
as a result of sampling $W \sim \DistL_n(\alpha)$. 
