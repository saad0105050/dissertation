...
\subsection{Moment bounds for GP}
...
\subsection{Min-entropy loss in a single epoch}
\begin{theorem}[Informal, single epoch]\label{thm:praos-thm-singleepoch-informal}
...
\subsection{Min-entropy loss over multiple epochs}
\iftoggle{drawfigs}{
